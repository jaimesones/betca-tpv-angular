...
import {ArticlesFamilyDialogComponent} from "./articles-family/articles-family-dialog.component";
import { SelectBudgetDialogComponent } from './select-budget-dialog.component';
...
export class ShoppingCartComponent implements OnInit {
  ...
  addDiscount(mobile): void {
    this.dialog.open(CustomerDiscountDialogComponent, {data: {mobile:mobile, cart:this.shoppingCart
      }}).afterClosed()
      .subscribe(_ => {
        this.synchronizeShoppingCart();
      });
